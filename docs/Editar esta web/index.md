...
| Si quieres... | Ve a |
|---|---|
| Crear tu cuenta para poder editar | [Crear una cuenta de GitHub](crear-cuenta-github.md) |
| Corregir o ampliar una página que ya existe | [Editar una página](editar-una-pagina.md) |
| Añadir una página nueva | [Crear una página nueva](crear-una-pagina.md) |
| Poner capturas de pantalla o fotos | [Subir imágenes](subir-imagenes.md) |
| Saber cómo se ponen negritas, listas, enlaces... | [Lo básico de Markdown](markdown-basico.md) |

!!! warning "Ojo con los documentos oficiales"
